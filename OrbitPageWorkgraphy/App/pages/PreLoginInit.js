...
define(['angular'], function() {
    ...
    var dependances = ['restangular', 'ngtimeago', 'ngAnimate', 'angularFileUpload', 'ngResource', 'ngRoute', 'ngSanitize', 'ngAutocomplete', 'angucomplete-alt', 'angular-input-stars', 'ui.bootstrap'];
