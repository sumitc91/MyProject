...
define(['angular'], function() {
    ...
    var dependances = ['restangular','angularFileUpload','ngAnimate','ngResource','ngRoute', 'ngSanitize', 'ngAutocomplete', 'angucomplete-alt', 'angular-input-stars', 'ui.bootstrap'];
