...
define([appLocation.preLogin], function (app) {
    ...
    app.controller('beforeLoginViewPostDetail', function ($scope, $http, $upload, $timeout, $routeParams, $rootScope, CookieUtil) {
        ...
        function createNewMessageOnUserPost(postIndex) {
            ...
            var url = ServerContextPath.userServer + '/User/UserCommentOnPost?message=' + $scope.UserPostList[postIndex].postInfo.postUserComment + '&image=' + '' + '&vertexId=' + $scope.UserPostList[postIndex].postInfo._id + '&wallVertexId=' + $scope.UserPostList[postIndex].postedToUser._id + '&postPostedByVertexId=' + $scope.UserPostList[postIndex].userInfo[0]._id;
            var headers = {
