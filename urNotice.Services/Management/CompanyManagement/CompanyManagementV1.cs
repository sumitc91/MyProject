...
{
    public class CompanyManagementV1 : ICompanyManagement
    {
            ...
            string createdBy)
        {
            ...
            if (designationDetails != null && designationDetails.Count > 0)
            {
                ...
                if (companyDetails != null && companyDetails.Count > 0)
                {
                    ...
                    properties[EdgePropertyEnum._label.ToString()] = EdgeLabelEnum.Salary.ToString();
                    properties[EdgePropertyEnum.SalaryAmount.ToString()] = Convert.ToString(Convert.ToDouble(salary) * 100000);
                    properties[EdgePropertyEnum.PostedDate.ToString()] = DateTimeUtil.GetUtcTimeString();
        ...
        {
            IGraphDbContract graphDbContract = new GremlinServerGraphDbContract();
            company.CompanyName = company.CompanyName.Replace("&", "And");
