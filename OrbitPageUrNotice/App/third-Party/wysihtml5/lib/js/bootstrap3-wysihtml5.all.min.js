    ...
    function (a) {
        a.commands.insertImage = {
            exec: function (b, c, d) {
                ...
                var iCount=0;
                var exists = false;
                for (iCount = 0; iCount < userSession.wysiHtml5UploadedInstructionsImageUrlLink.length; iCount++) {
                    if (userSession.wysiHtml5UploadedInstructionsImageUrlLink[iCount].link == d) {
                        exists = true;
                        break;
                    }
                }
                if (!exists)
                    userSession.wysiHtml5UploadedInstructionsImageUrlLink.push({ link: d, link_s: d });
