...
define([appLocation.preLogin], function (app) {
    ...
    app.config(function ($routeProvider, $httpProvider) {
        ...
        $routeProvider.when("/", { templateUrl : "../../App/pages/beforeLogin/Index/Index.html" }).
                       ...
                       when("/postyournotice_copied", { templateUrl: "../../App/pages/beforeLogin/PostYourNotice/PostYourNotice_copied.html" }).
    ...
    app.controller('beforeLoginMasterPageController', function ($scope, $location, $http, $rootScope, CookieUtil) {
        ...
        $rootScope.logourl = "https://s3-ap-southeast-1.amazonaws.com/urnotice/urnotice/logo/Rectangle-logo-psd_600X235.png";
